...
int main()
{
    ...
    Shader shader("exercises/5.2.exercise1/shader.vs.glsl", "exercises/5.2.exercise1/shader.fs.glsl");
    ...
    glm::mat4 trans(1.0f);
    trans = glm::rotate(trans, glm::radians<float>(45), glm::vec3(0.0f, 0.0f, 1.0f));
